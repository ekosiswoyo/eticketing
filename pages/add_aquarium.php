          ...
          <div class="box box-primary">
            ...
            <form action="" method="post">
              <div class="box-body">
                ...
                $query = mysqli_query($connect,"SELECT id_aquarium as maxKode FROM tb_aquarium order by no_aquarium desc limit 1");
                ...
                $abc = "AQ001";
                 $querys = mysqli_query($connect, "SELECT tanggal from tb_aquarium order by no_aquarium desc limit 1");
                ...
                <div class="form-group">
                  ...
                  if($now != $date){
                    ...
                    ?>
                  <input type="text" name="aquarium" class="form-control" id="exampleInputEmail1" value="<?php echo $abc;?>" readonly>
                  <?php 
                }
                  else{
                    ?>
                    <input type="text" name="aquarium" class="form-control" id="exampleInputEmail1" value="<?php echo $kodeAquarium;?>" readonly>
                    <?php
                  }
                  ?>
                </div>
...
if(isset($_POST['parkir'])){
  ...
  $id_user = $_POST['id_user'];
    ...
    $sql = "INSERT INTO tb_aquarium (id_user,id_aquarium,jml_orang,total,tanggal,jam) VALUES ('$id_user','$id_aquarium','1','$biayaorang','$date','$time')";
    $query = mysqli_query($connect, $sql);

    if($query){
       echo "<script>window.location='new_aquarium.php';</script>";
    }else{
