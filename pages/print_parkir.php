...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Ticket Parkir
        <small>#<?php echo $data['plat']; ?></small>
      </h1>
      <ol class="breadcrumb">
    ...
    <!-- Main content -->
    <section class="invoice" style="margin: auto; max-width: 500px;">
      <!-- title row -->
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Sistem Informasi eTicketing Pelabuhan
      ...
      <!-- info row -->
      <div class="row invoice-info"  style="margin: auto; max-width: 500px;">
        ...
        <tbody>
          ...
          <tr><th width='130px' scope='row' style="text-align:center;font-size: 40px;"><?php echo $data['plat'];?> </th> <th width='130px' scope='row'  style="text-align:center;font-size: 40px;">Rp <?php echo $data['biaya_parkir'];?></th></tr>
